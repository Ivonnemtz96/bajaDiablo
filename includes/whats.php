...
.wa__popup_chat_box_ct .wa__popup_heading_ct:before {
    content: '';
    background: url('/assets/img/whatsapp_logo.png') center top no-repeat;
...
<div class="wa__popup_chat_box">
    <div class="wa__popup_heading">
        <div class="wa__popup_title">¡Estamos para servirte!</div>
        <div class="wa__popup_intro"> <strong></strong>
    ...
    <div class="wa__popup_content wa__popup_content_left">
        ...
        <div class="wa__popup_content_list">
            <div class="wa__popup_content_item ">
                <a target="_blank" href="https://wa.me/+526242133413?text=Hola,%20me%20gustaría%20más%20información"
                    class="wa__stt wa__stt_online">
                    <div class="wa__popup_avatar">
                        <div class="wa__cs_img_wrap">
                            <img style="width: 5rem;" src="/img/chat.jpg" alt="">
                        </div>
                    </div>

                    <div class="wa__popup_txt">
                        <div class="wa__member_name">Baja Diablo</div>
                        <!-- /.wa__member_name -->
                        <!-- <div class="wa__member_duty">Asesoría</div> -->
                        <!-- /.wa__member_duty -->
                    </div>
                    <!-- /.wa__popup_txt -->
                </a>
