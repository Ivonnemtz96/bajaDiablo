    ...
    <div class="testimonial-block">
        ...
        <div class="testimonial-wrap">
            <div class="the-title text-center">
                <h5 class="head-title-2">¿Qué dicen nuestros clientes?</h5>
                <h2 class="head-title-1">
                    Opiniones
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testi-content">
                                <div class="testimonial-text">
                                    <p>
                                        "Buen ambiente, buen servicio y buenas bebidas. 👍👍😊"
                                    </p>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testi-content">
                                <div class="testimonial-text">
                                    <p>
                                        “Algo bien y excelente servicio”
                                    </p>
                                </div>
                                <div class="testimonial-detail-inner">
                                    <div class="testimonial-image">
                        ...
                        <div class="swiper-slide">
                            <div class="testi-content">
                                <div class="testimonial-text">
                                    <p>
                                        “Excelente servicio
                                        Las mejores micheladas
                                        Muy buen ambiente
                                        Recomiendo la doble canala de mango 🥭🤤🤤🤤”
                                    </p>
                                </div>
                                <div class="testimonial-detail-inner">
                                    <div class="testimonial-image">
